# -------------------------------------------------
#
# Script for parsing main information of a set of geometry
# optimizations (with vibrational frequencies calculation) 
# done in orca 4.2.1 using as input .log files
#
# The input format is: 'python geom_all.py'
#
# Output information: electronic parameters, vibrational
# frequencies and energy vs nº cycles representation
#
# Output files: filename.txt & filename.png for every file
# -------------------------------------------------
# =================================================
...
if __name__ == "__main__":
    ...
    #Specify what we want to read
    file_location = os.path.join('*.log')
    ...
    for f in filenames:
        ...
        output.write(f'Zero point energy (Eh) : {zero_value}\n')
        output.write(f'G-E(el) (Eh) : {g_value}\n')
        ...
        output.write(f'First 3 vibrational frequencies (cm**-1) : {joined_values}\n')
